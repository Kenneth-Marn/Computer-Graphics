...
private:
    ...
    glm::vec3 rotx(glm::vec3 v, float a);
    glm::vec3 roty(glm::vec3 v, float a);
    glm::vec3 rotz(glm::vec3 v, float a);
public:
    ObjectViewer( glm::vec3 eye, glm::vec3 at, glm::vec3 up );
    float getScaling() {return scaling;}
    
    void moveFB(float speed);       // forward- back
    void moveLR(float speed);       // left- right
